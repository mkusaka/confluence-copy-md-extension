...
describe("adfToMarkdown", () => {
  it("prepends page metadata as YAML frontmatter", () => {
    ...
    expect(markdown).toContain(
      'url: "https://example.atlassian.net/wiki/spaces/EX/pages/123456/Example+Page"',
    );
    expect(markdown).toContain(
      'editUrl: "https://example.atlassian.net/wiki/pages/resumedraft.action?draftId=123456"',
    );
